...
ActiveRecord::Schema.define(:version => 6) do
  ...
  add_index "site_mappings", ["chunk_id"], :name => "altered_site_mappings_chunk_id_index"
  add_index "site_mappings", ["depth"], :name => "altered_site_mappings_depth_index"
  add_index "site_mappings", ["lft", "rgt"], :name => "altered_site_mappings_lft_index"
  add_index "site_mappings", ["parent_id"], :name => "altered_site_mappings_parent_id_index"
  add_index "site_mappings", ["path_segment", "version"], :name => "altered_site_mappings_path_segment_index"
